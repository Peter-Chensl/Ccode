        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               /* string sql = string.Format("select count(*) from xianguo where sid='{0}'",textBox1.Text);
                ...
                if(0 == a)
                {*/
                   string sql = "INSERT INTO xianguo(object,sid,sname,class,score) VALUES('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "','"  + "')";
                   MySqlCommand cmd = new MySqlCommand(sql, sq);
                    ...
                    {
                        MessageBox.Show("添加失败！", "信息提示", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                        this.Close();
                    }
               /* }
                else
